...
version control and dynamic report generation (Quarto) in your own work
right away. Below, we’ll guide you through the setup step by step. There
are other, perhaps more elegant, ways to add version control to a
...
- In the search box that appears, type `azwadriqbal` and select Azwad’s
  name/username
