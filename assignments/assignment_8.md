...
-   This homework is due by **10pm on Wednesday 04/07/20**. Please
...
**Hint:** `str_c()` is the tidyverse version of `paste()` that was
mentioned in class. Use its help file (`?str_c`) to check out how it
works.
...
In the next exercise, however, you will need to clean up the data in the
loop before you can combine them.

![](assignment_8_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->![](assignment_8_files/figure-gfm/unnamed-chunk-15-2.png)<!-- -->
