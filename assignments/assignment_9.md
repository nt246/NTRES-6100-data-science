...
- This homework is due by **10pm on Thursday 10/30/2025**. Please upload it
  using your personal GitHub repository for this class.

- Please name your Quarto file `assignment_9.qmd` and the knitted
...
-   For this assignment the use of AI tools (e.g., chatGPT, Microsoft
    ...
    -   Finally complete the **Reflection** section at the end of the assignment.
