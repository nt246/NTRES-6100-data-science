...
2. Create a new Quarto file and name it `analysis.qmd`. Choose html as the output format if you're using the "Create Quarto document wizard, but change it to `output: gfm` in the file (GitHub Flavored Markdown, to display nicely on GitHub. 
