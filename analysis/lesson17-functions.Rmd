...
* [Chapter 25](https://r4ds.hadley.nz/functions.html) in R for Data Science (2e)
...
## Announcements
If you haven't already, please indicate in the signup sheet linked in the `General` channel on Slack whether you will be giving a final class presentation next Thursday 
...
Next Tuesday (11/4 - final class): Guest lecture by data librarian Sarah Wright on archiving data and code
