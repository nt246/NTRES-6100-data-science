...
```{r, eval = FALSE}
ggsave(plot1, file = "path_to_figure/filename.png")
```
...
Specify a size
```{r, eval = FALSE}
ggsave(file = "path_to_figure/filename.png", width = 5, height = 3)
...
```{r, eval = FALSE}
ggsave(file = "path_to_figure/filename.png")
ggsave(file = "path_to_figure/filename.pdf")
ggsave(file = "path_to_figure/filename.jpg")
```
