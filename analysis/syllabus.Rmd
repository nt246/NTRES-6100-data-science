...
| 4       | Wed | 2/17 | Collaborating with GitHub Part 1                                                              | [Assignment 1 due](https://github.com/nt246/NTRES-6100-data-science/blob/main/assignments/assignment_1.md) |
|         | Fri | 2/19 | Lab 2                                                                                         |                  |
| 5       | Mon | 2/22 | Collaborating with GitHub Part 2                                                              |                  |
| 6       | Wed | 2/24 | Plotting with ggplot part 1                                                                   | Assignment 2 due |
|         | Fri | 2/26 | Lab 3                                                                                         |                  |
| 7       | Mon | 3/1  | Data wrangling part 1 (dplyr::filter, mutate, select, arrange)                                |                  |
| 8       | Wed | 3/3  | Data wrangling part 2 (dplyr::summarize, group_by)                                            | Assignment 3 due |
|         | Fri | 3/5  | Lab 4                                                                                         |                  |
| 9       | Mon | 3/8  | Plotting with ggplot part 2 + good coding practices                                           |                  |
|         | Wed | 3/10 | **NO CLASS** - Cornell Wellness Break                                                         | Assignment 4 due |
|         | Fri | 3/12 | Lab 5                                                                                         |                  |
| 10      | Mon | 3/15 | Good coding practices, debugging strategies, and getting help (Guest lecture by Erika Mudrak) |                  |
| 11      | Wed | 3/17 | Tidy data (what is tidy data and how to handle untidy data)                                   | Assignment 5 due |
|         | Fri | 3/19 | Lab 6                                                                                         |                  |
| 12      | Mon | 3/22 | Data import, export, and parsing                                                              |                  |
| 13      | Wed | 3/24 | Factors in R                                                                                  | Assignment 6 due |
|         | Fri | 3/26 | Lab 7                                                                                         |                  |
| 14      | Mon | 3/29 | Relational data (join functions)                                                              |                  |
| 15      | Wed | 3/31 | Iteration (for loops) and conditional execution part 1                                        | Assignment 7 due |
|         | Fri | 4/2  | Lab 8                                                                                         |                  |
| 16      | Mon | 4/5  | Iteration (for loops) and conditional execution part 2                                        |                  |
| 17      | Wed | 4/7  | Functions                                                                                     | Assignment 8 due |
|         | Fri | 4/9  | Lab 9                                                                                         |                  |
| 18      | Mon | 4/12 | Catching up                                                                                   |                  |
| 19      | Wed | 4/14 | Student presentations, wrapping up and looking ahead                                          | Assignment 9 due |
|         | Fri | 4/16 | Lab 10                                                                                        |                  |
