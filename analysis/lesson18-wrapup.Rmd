---
title: "Lesson 19: Wrapping up and looking ahead"
output: 
  html_document:
    toc: true
---
...
* [R for Data Science](https://r4ds.hadley.nz/) by Wickham, Çetinkaya-Rundel, and Grolemund. See also answers to the exercises [here](https://mine-cetinkaya-rundel.github.io/r4ds-solutions/) or [here](https://jrnold.github.io/r4ds-exercise-solutions/) for solutions to the [first edition of R4DS](https://r4ds.had.co.nz/index.html), as well as a dedicated [R4DS Slack workspace](https://dslc.io/) for community learning. [I strongly recommend working through the chapters of this book that we have not covered]
...
* [A ModernDive into R and the tidyverse](https://moderndive.com/v2/) by Chester Ismay and Albert Y. Kim  
...
Check out the [Dashboard](https://ramikrispin.github.io/coronavirus_dashboard/#summary) developed for the continually updated [Coronavirus dataset](https://github.com/RamiKrispin/coronavirus) we worked with earlier in the course. Note that you can grab all the code in the [linked GitHub repo](https://github.com/RamiKrispin/coronavirus_dashboard/tree/master)

Dashboards can also be made interactive with dynamic and user-controlled displays of data through use of [Shiny](https://shiny.posit.co/), an R package that makes it easy to build interactive web apps straight from R.
...
R has lots of functionality for making maps. See some examples of a beautiful application to illustrate the distribution patterns of birdpopulations through the [Bird Genoscape Project](https://www.birdgenoscape.org/american-redstart/)

Some example code for making similar maps:
https://github.com/eriqande/make-a-BGP-map?tab=readme-ov-file
https://eriqande.github.io/rep-res-eeb-2017/plotting-spatial-data-with-ggplot.html
https://eriqande.github.io/rep-res-eeb-2017/a-tidy-approach-to-spatial-data-simple-features.html

<br>

Here are some other useful tutorials:
https://www.andrewheiss.com/blog/2023/07/28/gradient-map-fills-r-sf/index.html
https://learning.nceas.ucsb.edu/2023-04-coreR/session_15.html

Here's the cheatsheet for the very useful package sf
...
If you need to use Python for part of your analysis, check out the [reticulate package](https://rstudio.github.io/reticulate/) that facilitates interoperability between Python and R. 

<br>
<br>

### Quarto
If you're integrating multiple languages, or if you want to compile different types of outputs, also consider adopting [Quarto](https://quarto.org/) in place of RMarkdown. Quarto is a multi-language, next-generation version of R Markdown from Posit and includes dozens of new features and capabilities while at the same being able to render most existing Rmd files without modification. Quarto combines the functionality of R Markdown, bookdown, distill, xaringian, etc into a single consistent system with “batteries included”, the developers say it reflects everything we’ve learned from R Markdown over the past 10 years. See an introductory tutorial for RStudio users [here](https://quarto.org/docs/get-started/hello/rstudio.html)
