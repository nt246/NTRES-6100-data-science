...
* Course communication will primarily be through Slack. Please make sure you have joined our workspace to not miss announcements about scheduling changes etc.
...
* [Assignment 1](https://github.com/nt246/NTRES-6100-data-science/blob/main/assignments/assignment_1.md) due 2/17 (we will go through how to submit through GitHub next week)  
...
* [Chapter 10: Cache credentials for HTTPS in Jenny Bryan's Happy Git with R](https://happygitwithr.com/credential-caching.html)
...
For now, GitHub still allows authentication with your username and password, so you *can* proceed without this step. However, from August 2021 [GitHub will require token- or SSH-based authentication](https://github.blog/2020-12-15-token-authentication-requirements-for-git-operations/), so let's get set up with that right away so your workflows won't be interrupted when the standard username-password authentication stops working.
