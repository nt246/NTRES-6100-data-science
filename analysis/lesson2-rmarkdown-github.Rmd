...
* We will use the `lecture-chat` channel in Slack rather than the Zoom chat (disabled). Feel free to post questions or let us know if you're having software issues or can't get demos to work on your computer during the lecture 
* Zoom recordings are available at the [course Canvas site](https://canvas.cornell.edu/courses/51175)
...
* [Assignment 1](https://github.com/nt246/NTRES-6100-data-science/blob/main/assignments/assignment_1.md) due 02/02 (we will go through how to submit through GitHub next week)  
* Azwad will hold office hours Tuesdays 11.15-12.15 (room TBD)  
