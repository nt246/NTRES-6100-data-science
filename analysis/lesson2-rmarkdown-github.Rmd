...
**Required**:  
- [Chapters 28 and 29 in R for Data Science (2e)](https://r4ds.hadley.nz/quarto.html)   
...
- The [Quarto Tutorial: Computations](https://quarto.org/docs/get-started/computations/) 
- [Comprehensive guide to using Quarto](https://quarto.org/docs/guide/) [great look-up resource]
...
* Zoom recordings are available at the [course Canvas site](https://canvas.cornell.edu/courses/88419/external_tools/1346)
