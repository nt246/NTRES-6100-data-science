...
## Announcements
* Reminder about the [end-of-class student presentations](https://github.com/nt246/NTRES-6100-data-science/blob/main/misc/student_presentations.md) next Thursday (March 31). If you can't make it to class (and are taking the course for credit), please submit a video of your presentation before the class
* Instead of a regular lab session next week, Nicolas will offer optional 30-min consultations to discuss your project or analysis need. If you're interested, please sign up [here](https://docs.google.com/spreadsheets/d/1pSCsHBltGWZ_GlTL7XKrIsYn3EYuExvojNXc1N6ClyA/edit#gid=0). We will give preference to those enrolled in the lab sessions, but if there is availability, other's are welcome.
