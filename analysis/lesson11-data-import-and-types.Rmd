...
We get a warning message here, we can look at what the issue is by typing `problem()`. We note that despite that warning, now the "Missing" is being read in as NA, the size column gets read in as a double.
