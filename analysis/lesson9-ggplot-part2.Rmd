...
First, let's load our packages and read in our Coronavirus dataset. You can choose to either work in an R-script or an RMarkdown document today.
...
There are many overviews of the different arguments to `linetype`, `shape` etc on the internet, e.g. [here](http://www.cookbook-r.com/Graphs/Shapes_and_line_types/).
