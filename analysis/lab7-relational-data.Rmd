...
* Today, we will combine the `join` functions and data transformation tools in `dplyr`, the data visualization tools in `ggplot2`, and the data tidying tools in `tidyr` to continue our exploration of the patterns and trends in the `nycflights13` dataset, the `babynames` dataset, and ...
...
## Exercise 2: Exploration of the `nycflights13` data (30 min)
...
See [here](https://jrnold.github.io/r4ds-exercise-solutions/relational-data.html#exercise-13.4.3)
...
#### Question 2: What weather conditions make it more likely to see a delay?

*One possible solution*
<details>
  <summary>click to expand</summary>

See [here](https://jrnold.github.io/r4ds-exercise-solutions/relational-data.html#exercise-13.4.4)
