...
For this exercise, you will build a GitHub Pages website as described in the [Lecture 5](https://nt246.github.io/NTRES-6100-data-science/lesson5-collaboration-part2.html) and display for data visualization result on this website. 

#### Suggested activities

- You can split your RMarkdown file into separate files, so each section (i.e. data, life expectancy, fertility, infant mortality) becomes a seperate page and can get it own tab.
