...
There are no required readings for today, but if you did not join our Zoom call last Thursday, please read through the [lecture notes](https://nt246.github.io/NTRES-6100-data-science/lesson4-collaboration.html) and watch the recording posted on [Canvas](https://canvas.cornell.edu/courses/39033)
...
* Check your grading basis on Student Center to make sure you're happy with your enrollment status (lab section and grading basis)
* You will do assignment 3 in collaboration you get assigned today, so make sure to exchange contact info when you first get put in breakout rooms
...
3. Scroll to the Github Pages section (second to last). It will say "Pages settings now has its own dedicated tab!" Click in `Check it out here!`
...
Then build your site by sourcing from the `main` branch and root directory. **Remember to click "save"** (on the same line as you chose the master branch as the source).
