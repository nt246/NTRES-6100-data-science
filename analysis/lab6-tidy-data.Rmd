...
Use data tidying, transformation, and visualization to answer the following questions about whale observation records in breakout rooms.
...
* The `whales` dataset was collected as follows: observers are asked for certain information about specific indicents they witnessed of ships striking whales and that information is compiled by whale type. The observers were asked to provide: type of whale, date of event (m/d/yr), outcome of event, approximate length of whale in feet, ocean in which event occurred.
...
#### Question 4. Starting from `whales_split`, create another data frame in which all columns are appropriately parsed. Name this data frame `whales_parsed`.

<br>

The variables should be of the following types (listed in order): integer, character, datetime, character, integer, character
