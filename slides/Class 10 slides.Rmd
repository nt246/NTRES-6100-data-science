...
* Assignment 4 due tomorrow - submit by pushing to your class GitHub repo
...
![](../docs/assets/tidy_data.png)


## Exercise

1. Compute the rate of tuberculosis cases per 10,000 
people for each country

<br>

2. Compute the total cases per year (across all countries)

<br>

3. Visualize case counts per country over the years
